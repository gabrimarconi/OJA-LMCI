...
companies_names_dataframe_m <- companies_names_dataframe[duplicated(companies_names_dataframe$ads_per_company)==FALSE , -1]
...
companies_freqtable_clean$tot_ads <- companies_freqtable_clean$n_companies * companies_freqtable_clean$Freq
